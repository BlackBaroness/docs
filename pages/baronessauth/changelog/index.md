...
- Улучшена обработка ошибок при неудачной перезагрузке или выключении того или иного компонента.
  Это всё ещё не делает неудачную перезагрузку допустимой в продакшне, но уменьшает вероятность, что её последствия нельзя будет исправить без полного рестарта.

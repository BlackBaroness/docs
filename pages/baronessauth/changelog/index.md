...
## 3.27.0 (11.4.2026)
### ✨ Новое
- Плагин больше не выключает BungeeCord, если выполнение /auth reload не удалось.
  В такой ситуации выводится новое сообщение и при его появлении следует как можно
  скорее решить как-то решить проблему, так как неправильное состояние систем может привести
  к неожиданным проблемам. Это выглядит лучше, чем выключение, так как порой лучше
  быстро исправить свою ошибку, чем терять онлайн.
### 🔧 Исправлено

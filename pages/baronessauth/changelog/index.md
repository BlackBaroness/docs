...
## 3.14.0 (23.10.2025)
### ✨ Новое
- Теперь плагин автоматически обнаруживает, что вы подключаетесь к MariaDB, когда включена MySQL, и самостоятельно переключается в режим MariaDB. Это позволяет избежать проблем с неправильным выбором для большинства сетапов.

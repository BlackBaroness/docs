...
- Ботам добавлено сообщение, которое показывается в чате при лимите привязок. Ранее такое сообщение было только в самом боте, отчего игроки с включённым `confirmation` могли его не заметить.

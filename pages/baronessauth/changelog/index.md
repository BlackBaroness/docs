...
На 16% быстрее при том же cost (1850ms -> 1550ms при cost 15)
На 28% компактнее - экономия места в БД (68 байт -> 49 байт)
Плагин будет автоматически обновлять формат паролей по мере входа игроков.
...
### 🔧 Исправлено
- Пароли могли не работать - баг версии 2.11.0.

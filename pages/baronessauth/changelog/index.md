...
- Уменьшен стандартный кулдаун на некоторые команды с 1.2с до 0.7с.
### 🔧 Исправлено
- Убрано логирование некоторых ненужных ошибок.
- Интеграция NanoLimbo с BungeeGuard не работала.
- При попытке установить игроку ID соцсети, когда он уже привязан, происходила ошибка.
### 📦 Обновлено

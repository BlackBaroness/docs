...
BaronessAuth предлагает лучшее из обоих решений: он поднимает лимбо-сервер автоматически. Это быстро, совместимо, легко и обычно работает с панельными хостингами.

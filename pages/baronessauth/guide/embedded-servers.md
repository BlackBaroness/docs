...
|:--------------:|:-------------------:|:-----------------:|:----------------:|:--------------------------------:|
|   picolimbo    |    1.7 - 1.21.11    | Не поддерживаются | От 2 до 15  МБ   |   Схематика не нужна, экономия   |
|   nanolimbo    |    1.7 - 1.21.11    | Не поддерживаются | От 70   МБ       |   Схематика не нужна, экономия   |
| paper (1.8.8)  |    1.8 - 1.21.11    |      mcedit       | От 500  МБ       |    Старая схематика, экономия    |
| paper (1.12.2) |    1.9 - 1.21.11    |      mcedit       | От 500  МБ       |    Старая схематика, экономия    |
| paper (1.16.5) |    1.9 - 1.21.11    | mcedit, sponge.1  | От 700  МБ       | Более новая схематика, экономия  |
| paper (latest) |    1.9 - 1.21.11    |        все        | От 1000 МБ       | Новейшая схематика, не жалко ОЗУ |
...
- Тратит лишь 15 МБ ОЗУ даже при больших наплывах игроков.
...
Основанный на [NanoLimbo](https://github.com/BoomEaro/NanoLimbo/tree/feature/1.21.2), этот сервер довольно лёгкий и быстрый.
...
## Типы серверов / `paper (1.8.8)`

Полный сервер с максимальным урезанием настроек, версии 1.8.8.
...
- Не поддерживает BungeeGuard Forwarding.
- Не поддерживает Velocity Forwarding.
...
- Поддерживает схематики формата `mcedit`.
- Требует от 500 МБ ОЗУ (зависит от размера схематики).
- Тратит довольно мало процессорного времени.
...
- Требует от 700 МБ ОЗУ (зависит от размера схематики).
...
- Требует от 1000 МБ ОЗУ (зависит от размера схематики).
